...
namespace NoteApp                                                       
{
    ...
    public class Note
    {
        ...
        public DateTime LastChangeDate
        {
            ...
            set { SetLastChangeDate(DateTime.Now);}
        }

        /// <summary>
        /// Метод, возващающий или устанавливающий время изменения заметки.
        /// </summary>
        private void SetLastChangeDate(DateTime timeValue)
        {
            _lastChangeDate = timeValue;
        }
